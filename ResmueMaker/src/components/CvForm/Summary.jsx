...
const Summary = ({activeSection,addComponent,removeComponent}) => {
  ...
  return (
    ...
    <textarea style = {{padding:"15px", fontSize:"24px"}}name="" id="" cols="30" rows="10" placeholder='e.g. Passionate science teacher with 8+ experience and a track record of ...'></textarea>
    </div>
  </animated.div> 
  )
}
