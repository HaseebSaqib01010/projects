...
const AreaOfExpertise = ({activeSection,addComponent,removeComponent,allExpertise}) => {
  ...
  return (
    ...
    <animated.div style={formAnimation}>
     ...
     {/* <p style={{ color: "gray" }}>
        ...
        {allExpertise?.map((singleExpertise)=>{
                    return (
                      <div>
      ...
      <div style={{display:"flex",width:"100%"}}>
        ...
        <button style={{ fontSize: "20px",backgroundColor:"white",border:"none",position:"relative",top: "-10px",right: "5px", height: "0px" }} onClick={() => removeComponent(singleExpertise.id)}>
                <i
