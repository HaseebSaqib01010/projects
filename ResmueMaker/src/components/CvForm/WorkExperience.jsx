...
const WorkExperience = ({activeSection,addComponent,removeComponent,allExperience}) => {
  ...
  return (
    <animated.div  style={formAnimation}>
       ...
       {/* <p style={{ color: "gray" }}>
        ...
        {allExperience?.map((singleExperience)=>{
                   return (      
       <div>
      ...
      <div  key={singleExperience.id} style={ {border:"solid lightgrey 1px", padding:"20px",margin:"10px"}}>
      ...
      <div style={{display:"flex",width:"100%"}}>
        <div className="col-md-12 col-lg-6 px-2">
          ...
          <input type="text" className="12" placeholder="e.g. SQA  " />
        </div>
        <div className="col-md-12 col-lg-6 px-2">
          <label htmlFor="" className="col-12">
            Employer
        ...
        <button style={{ fontSize: "20px",backgroundColor:"white",border:"none",position:"relative",top: "-10px",right: "5px", height: "0px" }} onClick={() => removeComponent(singleExperience.id)}>
                <i
        ...
        <div className="col-md-12 col-lg-6 px-2">
          ...
          <input type="text" className="12" placeholder="e.g. automation " />
        </div>
        <div className="col-md-12 col-lg-6 px-2">
          <label htmlFor="" className="col-12">
            City
    ...
    <textarea style = {{padding:"20px", fontSize:"20px",width:"100%",border:"solid 1px lightGrey"}}name="" id="" cols="30" rows="10" placeholder='e.g. Created and Implemented lesson plans based on child-led interests and curiosities.'></textarea>
      </div>
